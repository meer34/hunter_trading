...
public class StockOutService {
	...
	public Page<StockOut> getAllStockOutsForProduct(String name, String pSize, String colour, String brand, String productType, Integer pageNo, Integer pageSize) {
		return stockOutRepo.findAllStockOutsByProductDetails(PageRequest.of(pageNo, pageSize), name,pSize, colour, brand, productType);
	}
