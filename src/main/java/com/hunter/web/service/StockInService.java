...
public class StockInService {
	...
	public Page<StockIn> getAllStockInsForProduct(String name, String pSize, String colour, String brand, String productType, Integer pageNo, Integer pageSize) {
		return stockInRepo.findAllStockInsByProductDetails(PageRequest.of(pageNo, pageSize), name,pSize, colour, brand, productType);
	}
	...
	public List<String[]> getProductTypesForNameAndSizeAndColourAndBrand(String name, String size, String colour, String brand) {
		return productRepo.findProductTypesForNameAndSizeAndColourAndBrand(name, size, colour, brand);
	}
